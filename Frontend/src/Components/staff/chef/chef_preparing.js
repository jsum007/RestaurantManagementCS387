  ...
  render() {
    return (
      <div class="chef_main">
        ...
        <br></br>
        <h2 style={{color:"white",textAlign:"left", marginLeft:"20px",fontWeight:"bold"}}>Dish being prepared.....</h2>
        <div class="dish_tile">
          Dish
        </div>
        <div class="left">
        <Link to="/chef"><button type="button" class="btn btn-secondary">Ready to serve!</button></Link>
        </div> 
        <div class="chef_info">
